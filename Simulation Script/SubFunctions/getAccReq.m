...
% timeToVelocity = norm(localPath(velocityAimpoint,:))/((currentVelocity+desiredVelocity)/2);
% 
% % Transform into acceleration
% accelerationRequest = (desiredVelocity-currentVelocity)/timeToVelocity;
% 
...
% DMVelocity.timeToVelocity = timeToVelocity;
...
accelerationRequest = (5-currentVelocity);
